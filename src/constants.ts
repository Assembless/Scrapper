...
export const MAX_PRODUCTIONS = 5683;
...
export const PROMPTS_MESSAGES = {
  ...
  chooseFile: textWhite(`What file would you like to upload ?`),
...
export const LOGS_MESSAGES = {
  ...
  mainInstanceStart: { start: textYellow(`Starting main instance`), succeed: textGreen(`Main instance started`), fail: textRed(`Main instance starting failed`) },
